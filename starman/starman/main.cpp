...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    // ビュー変換
        ...
        D3DXVECTOR3 a = D3DXVECTOR3(47.5f * cos(D3DXToRadian(Ang * 0.7f)), 70.2f * cos(D3DXToRadian(Ang * 0.2f)), 56.7f * sin(D3DXToRadian(Ang * 1.2f)));
        D3DXVECTOR3 b = D3DXVECTOR3(0, 0, 0);
        D3DXVECTOR3 c = D3DXVECTOR3(sin(D3DXToRadian(Ang * 0.4f)), 1, 0);
        D3DXMatrixLookAtLH(
            &View,
            &a,
            &b,
