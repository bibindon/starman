...
void SeqBattle::ShowStorehouse()
{
    ...
    // ëqå…ÇÕï°êîë∂ç›Ç≈Ç´ÇÈÅB
    // ãóó£Ç™ãﬂÇ¢ëqå…ÇëŒè€Ç∆Ç∑ÇÈ
...
void SeqBattle::Render()
{
    ...
    {
        // ÉCÉJÉ_ÇÕèÊÇ¡ÇƒÇ¢ÇƒÇ‡èÊÇ¡ÇƒÇ¢Ç»Ç≠ÇƒÇ‡èÌÇ…ï\é¶Ç∑ÇÈÇ◊Ç´Ç‡ÇÃÇ»ÇÃÇ≈
        // Ç±Ç±Ç≈ÇÕâΩÇ‡ÇµÇ»Ç¢ÅB
    }
