...
SeqBattle::SeqBattle(const bool isContinue)
{
    ...
    // HUD
    {
        ...
        m_hud->UpsertStatus("êgëÃÇÃÉXÉ^É~Éi", 100, 100, true);
        m_hud->UpsertStatus("î]ÇÃÉXÉ^É~Éi", 100, 100, true);
        m_bShowHud = false;
    }
}
...
//            SaveLastStage(2);
    ...
    //---------------------------
    {
        ...
        m_hud->UpsertStatus("êgëÃÇÃÉXÉ^É~Éi",
                            (int)(work3 * 100 / work1),
                            (int)(work2 * 100 / work1),
                            true);
        ...
        m_hud->UpsertStatus("î]ÇÃÉXÉ^É~Éi",
                            (int)(work3 * 100 / work1),
                            (int)(work2 * 100 / work1),
                            true);
    }
